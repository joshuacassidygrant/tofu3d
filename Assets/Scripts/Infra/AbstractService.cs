...
public abstract class AbstractService : IService, IListener
{
    ...
    private Dictionary<Events, List<Action<EventPayload>>> _boundListeners;
    ...
    public void BindServiceContext(ServiceContext serviceContext)
    {
        ServiceContext = serviceContext;
        serviceContext.Bind(GetType().Name, this);
    }
    ...
    public void ReceiveEvent(Events evnt, EventPayload payload)
    {
    ...
    public void BindListener(Events evnt, Action<EventPayload> action, EventContext evntContext)
    {
        if (_boundListeners == null) _boundListeners = new Dictionary<Events, List<Action<EventPayload>>>();
    ...
    public void UnbindListener(Events evnt, Action<EventPayload> action, EventContext evntContext)
    {
